<div class="main-banner banner text-center">
	  <div class="container">    
			<h1><span class="segment-heading">Semuanya terhubung </span> dengana tokoproyek.com</h1>
			<p>Pasarkan product atau jadi bagian dari kami</p>
				...
				<div class="container">
					...
					<div class="col-md-2 focus-grid">
						<a href="categories.html#parentVerticalTab3">
							<div class="focus-border">
								<div class="focus-layout">
									<div class="focus-image"><i class="fa fa-building"></i></div>
									<h4 class="clrchg">Alat Berat</h4>
								</div>
							</div>
						</a>
					</div>	
						...
						<a href="categories.html#parentVerticalTab4">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">Alat Ringan</h4>
								</div>
							</div>
						</a>
					</div>	
							...
							<ul id="flexiselDemo3">
								<li>
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p1.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p2.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p3.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p4.jpg"/>
								...
								<li>
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p5.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p6.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p7.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p8.jpg"/>
								...
								<li>
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p9.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p10.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p11.jpg"/>
									...
									<div class="col-md-3 biseller-column">
										<a href="single.html">
											<img src="<?=base_url()?>assets/images/p12.jpg"/>
